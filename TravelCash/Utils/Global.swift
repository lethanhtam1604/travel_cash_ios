...
class Global {
    ...
    static let colorMidBlue = UIColor(0x42A5F5)
    static let colorPink = UIColor(0xE91E63)
    static let colorPage = UIColor(0xE7E8EA)
    static let colorLikeBtn = UIColor(0x94E691)
    static let colorShareBtn = UIColor(0xDE7B7B)
    ...
    static let baseUrl = "http://72.27.213.70:8080/lms-api/"
    static let imageUrl = "http://72.27.213.70:8080//lms-mobile/promotions/"

    static var currentUser: User?
    static var newLoanApp = NewLoanApp()
}
